...
let s:cdSearchCurrent = {'gui': '#49545F', 'cterm': s:cterm09, 'cterm256': '09'}
let s:cdSearch = {'gui': '#4C4E50', 'cterm': s:cterm0A, 'cterm256': '09'}
...
call <sid>hi('Special', s:cdSpecial, {}, 'none', {})
call <sid>hi('SpecialChar', s:cdSpecial, {}, 'none', {})
